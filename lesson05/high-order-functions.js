...
let writeConsole = function (i) { console.log(i) }
let writeConsoleWithArrowFunction = i => console.log(i)


repeat(10, writeConsole)
repeat(10, writeConsoleWithArrowFunction)
repeat(10, function (i) { console.log(i) })
